...
game.exe:		game.obj    voxlap5.obj v5.obj kplib.obj winmain1.obj $(SRC)/game.c;
...
voxed.exe:		voxed.obj   voxlap5.obj v5.obj kplib.obj winmain2.obj $(SRC)/voxed.c;
...
game.obj:		$(SRC)/game.c $(SRC)/voxlap5.h $(SRC)/sysmain.h;
											$(CC) /Fo$(OUTBIN)/$(@B) /c /J /TP $(SRC)/game.c      /Ox /Ob2 /G6Fy /Gs /MD /QIfist
simple.obj:		$(SRC)/simple.c $(SRC)/voxlap5.h $(SRC)/sysmain.h;
											$(CC) /Fo$(OUTBIN)/$(@B) /c /J /TP $(SRC)/simple.c    /Ox /Ob2 /G6Fy /Gs /MD /QIfist
voxed.obj:		$(SRC)/voxed.c $(SRC)/voxlap5.h $(SRC)/sysmain.h;
											$(CC) /Fo$(OUTBIN)/$(@B) /c /J /TP $(SRC)/voxed.c     /Ox /Ob2 /G6Fy /Gs /MD
kwalk.obj:		$(SRC)/kwalk.c $(SRC)/voxlap5.h $(SRC)/sysmain.h;
											$(CC) /Fo$(OUTBIN)/$(@B) /c /J /TP $(SRC)/kwalk.c     /Ox /Ob2 /G6Fy /Gs /MD


voxlap5.obj:	$(SRC)/voxlap5.c $(SRC)/voxlap5.h;
											$(CC) /Fo$(OUTBIN)/$(@B) /c /J /TP $(SRC)/voxlap5.c   /Ox /Ob2 /G6Fy /Gs /MD
#v5.obj:			$(SRC)/v5.masm;
#											$(AS) /Fo$(OUTBIN)/$(@B) /c /coff $(SRC)/v5.masm
v5.obj:			$(SRC)/v5.nasm;
											"C:/Program Files/nasm/nasm.exe" -o $(OUTBIN)/$(@B).obj $(SRC)/v5.nasm -f win32
kplib.obj:		$(SRC)/kplib.c;
											$(CC) /Fo$(OUTBIN)/$(@B) /c /J /TP $(SRC)/kplib.c     /Ox /Ob2 /G6Fy /Gs /MD
